...
final class CrearTablaTorneoConEquiposYPartidos extends AbstractMigration
{
    ...
    public function change(): void
    {
        ...
        ->addColumn('partidosJugados','integer')
        ->addColumn('partidosGanados','integer')
        ->addColumn('partidosEmpatados','integer')
        ->addColumn('partidosPerdidos','integer')
        ->addColumn('golesAFavor','integer')
        ->addColumn('golesContra','integer')
