...
class Partido extends Model
{
  ...
  public function setGolesLocal(?int $goles_local): void
  {
    $this->goles_local = $goles_local;
  }
  public function setGolesVisitante(?int $goles_visitante): void
  {
  ...
  public function setCancha(?string $cancha): void
  {
    $this->cancha = $cancha;
  }
}
